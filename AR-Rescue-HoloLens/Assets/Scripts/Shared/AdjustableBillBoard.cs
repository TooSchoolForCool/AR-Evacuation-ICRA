...
{
    /// <summary>
    /// The PlaneBillBoard class implements the behaviors needed to keep a GameObject oriented towards the user.
    /// </summary>
    public class AdjustableBillBoard : MonoBehaviour
    {
        /// <summary>
        ...
        [Tooltip("Adjustment Rotation")]
        [SerializeField]
        private Vector3 rotationAdjustment = new Vector3(0.0f, 0.0f, 0.0f);
        public Vector3 RotationAdjustment
        {
            get { return rotationAdjustment; }
            set { rotationAdjustment = value; }
        }
